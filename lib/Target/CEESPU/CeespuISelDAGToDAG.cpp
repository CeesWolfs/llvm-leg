...
//===----------------------------------------------------------------------===//
//
// This file defines a DAG pattern matching instruction selector for Ceespu,
// converting from a legalized dag to a Ceespu dag.
//
//===----------------------------------------------------------------------===//
...
class CeespuDAGToDAGISel : public SelectionDAGISel {
public:
  explicit CeespuDAGToDAGISel(CeespuTargetMachine &TM) : SelectionDAGISel(TM) {}
...
bool CeespuDAGToDAGISel::SelectAddr(SDValue Addr, SDValue &Base, SDValue &Offset) {
...
// ComplexPattern used on Ceespu FI instruction
bool CeespuDAGToDAGISel::SelectFIAddr(SDValue Addr, SDValue &Base, SDValue &Offset) {
  SDLoc DL(Addr);
...
SDNode *CeespuDAGToDAGISel::Select(SDNode *Node) {
